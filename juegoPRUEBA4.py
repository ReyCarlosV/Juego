...
def mover_numeros(delta_fila, delta_columna):
    ...
    for fila, columna in posiciones_ordenadas:
        if (fila, columna) in posiciones_con_numeros:
            ...
            # Mover el número en la dirección deseada
            while True:
                ...
                if 0 <= siguiente_fila < 4 and 0 <= siguiente_columna < 4:
                    ...
                    siguiente_fila, siguiente_columna) not in sumado:
                        ...
                        posiciones_con_numeros[(fila, columna)] = ""  # Vaciar la posición original
                        break
                    elif (siguiente_fila, siguiente_columna) not in nuevas_posiciones:
            ...
            if (nueva_fila, nueva_columna) not in nuevas_posiciones:
                nuevas_posiciones[(nueva_fila, nueva_columna)] = posiciones_con_numeros[(fila, columna)]
            else:
                # Vaciar la celda original después de moverse
